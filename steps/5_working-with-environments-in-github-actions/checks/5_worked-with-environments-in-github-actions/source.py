...
def handler(event, context):
    ...
    return with_hint(len(jobs) >= 4, f'Expected to find (at least) 4 Azure Machine Learning jobs but found {len(jobs)} instead. Ensure all machine learning jobs have ran.')
