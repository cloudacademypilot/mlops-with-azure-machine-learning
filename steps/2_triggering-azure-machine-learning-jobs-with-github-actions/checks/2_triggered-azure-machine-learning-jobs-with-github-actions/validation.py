...
def handler():
    try:
        with open("steps/2_triggering-azure-machine-learning-jobs-with-github-actions/checks/2_triggered-azure-machine-learning-jobs-with-github-actions/params.json") as f:
            params = json.load(f)
